    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset('assets/${restaurant.imagePath}', width: 130.0),
            Text(
              'Mais pedidos',
            ...
            Column(
              children: List.generate(restaurant.dishes.length, (index) {
                ...
                return ListTile(
                  onTap: (){},
                  leading: Image.asset('assets/dishes/default.png', width: 50.0, height: 48,),
                  title: Text(dish.name),
                  subtitle: Text("R\$${dish.price.toStringAsFixed(2)}"),
                  trailing: IconButton(onPressed: (){
                    context.read<BagProvider>().addAllDishesToBag([dish]);
                  },
                   icon: Icon(Icons.add),
                  ),
                );
